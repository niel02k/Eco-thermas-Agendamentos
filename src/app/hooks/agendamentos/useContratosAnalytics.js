...
import { receitaPorMes } from '@/app/services/contratosServices';
...
export function useContratosAnalytics() {
  ...
  // Carregar todos os contratos para análise + receita mensal
  const carregar = useCallback(async () => {
    setLoading(true);
    setError(null);
    try {
      const [contratosRes, receitaRes] = await Promise.all([
        supabase
          .from('contratos')
